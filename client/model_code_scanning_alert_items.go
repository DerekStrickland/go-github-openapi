...
// CodeScanningAlertItems struct for CodeScanningAlertItems
...
func (o *CodeScanningAlertItems) SetFixedAtNil() {
	o.FixedAt.Set(nil)
}
...
func (o *CodeScanningAlertItems) SetDismissedCommentNil() {
...
func (o *CodeScanningAlertItems) GetRule() CodeScanningAlertRuleSummary {
	if o == nil {
		var ret CodeScanningAlertRuleSummary
		return ret
	}
...
func (o CodeScanningAlertItems) MarshalJSON() ([]byte, error) {
...
type NullableCodeScanningAlertItems struct {
	value *CodeScanningAlertItems
	isSet bool
}

func (v NullableCodeScanningAlertItems) Get() *CodeScanningAlertItems {
	return v.value
}

func (v *NullableCodeScanningAlertItems) Set(val *CodeScanningAlertItems) {
	v.value = val
	v.isSet = true
}

func (v NullableCodeScanningAlertItems) IsSet() bool {
	return v.isSet
}

func (v *NullableCodeScanningAlertItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCodeScanningAlertItems(val *CodeScanningAlertItems) *NullableCodeScanningAlertItems {
	return &NullableCodeScanningAlertItems{value: val, isSet: true}
}

func (v NullableCodeScanningAlertItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCodeScanningAlertItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
