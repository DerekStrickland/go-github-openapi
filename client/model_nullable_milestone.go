...
func (o NullableMilestone) MarshalJSON() ([]byte, error) {
...
type NullableNullableMilestone struct {
	value *NullableMilestone
	isSet bool
}

func (v NullableNullableMilestone) Get() *NullableMilestone {
	return v.value
}

func (v *NullableNullableMilestone) Set(val *NullableMilestone) {
	v.value = val
	v.isSet = true
}

func (v NullableNullableMilestone) IsSet() bool {
	return v.isSet
}

func (v *NullableNullableMilestone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNullableMilestone(val *NullableMilestone) *NullableNullableMilestone {
	return &NullableNullableMilestone{value: val, isSet: true}
}

func (v NullableNullableMilestone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNullableMilestone) UnmarshalJSON(src []byte) error {
	v.isSet = true
