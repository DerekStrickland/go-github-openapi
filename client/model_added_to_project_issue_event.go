...
func (o AddedToProjectIssueEvent) MarshalJSON() ([]byte, error) {
...
type NullableAddedToProjectIssueEvent struct {
	value *AddedToProjectIssueEvent
	isSet bool
}

func (v NullableAddedToProjectIssueEvent) Get() *AddedToProjectIssueEvent {
	return v.value
}

func (v *NullableAddedToProjectIssueEvent) Set(val *AddedToProjectIssueEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableAddedToProjectIssueEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableAddedToProjectIssueEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddedToProjectIssueEvent(val *AddedToProjectIssueEvent) *NullableAddedToProjectIssueEvent {
	return &NullableAddedToProjectIssueEvent{value: val, isSet: true}
}

func (v NullableAddedToProjectIssueEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddedToProjectIssueEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
