...
func (o *NullableCollaborator) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o *NullableCollaborator) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o NullableCollaborator) MarshalJSON() ([]byte, error) {
...
type NullableNullableCollaborator struct {
	value *NullableCollaborator
	isSet bool
}

func (v NullableNullableCollaborator) Get() *NullableCollaborator {
	return v.value
}

func (v *NullableNullableCollaborator) Set(val *NullableCollaborator) {
	v.value = val
	v.isSet = true
}

func (v NullableNullableCollaborator) IsSet() bool {
	return v.isSet
}

func (v *NullableNullableCollaborator) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNullableCollaborator(val *NullableCollaborator) *NullableNullableCollaborator {
	return &NullableNullableCollaborator{value: val, isSet: true}
}

func (v NullableNullableCollaborator) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNullableCollaborator) UnmarshalJSON(src []byte) error {
	v.isSet = true
