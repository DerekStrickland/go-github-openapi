...
func (o TimelineUnassignedIssueEvent) MarshalJSON() ([]byte, error) {
...
type NullableTimelineUnassignedIssueEvent struct {
	value *TimelineUnassignedIssueEvent
	isSet bool
}

func (v NullableTimelineUnassignedIssueEvent) Get() *TimelineUnassignedIssueEvent {
	return v.value
}

func (v *NullableTimelineUnassignedIssueEvent) Set(val *TimelineUnassignedIssueEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableTimelineUnassignedIssueEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableTimelineUnassignedIssueEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimelineUnassignedIssueEvent(val *TimelineUnassignedIssueEvent) *NullableTimelineUnassignedIssueEvent {
	return &NullableTimelineUnassignedIssueEvent{value: val, isSet: true}
}

func (v NullableTimelineUnassignedIssueEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimelineUnassignedIssueEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
