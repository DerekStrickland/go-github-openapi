...
func (o *NullableIssue) SetStateReasonNil() {
...
func (o *NullableIssue) SetBodyNil() {
	o.Body.Set(nil)
}
...
func (o *NullableIssue) SetActiveLockReasonNil() {
...
func (o *NullableIssue) SetClosedByNil() {
	o.ClosedBy.Set(nil)
}
...
func (o *NullableIssue) SetPerformedViaGithubAppNil() {
...
func (o NullableIssue) MarshalJSON() ([]byte, error) {
...
type NullableNullableIssue struct {
	value *NullableIssue
	isSet bool
}

func (v NullableNullableIssue) Get() *NullableIssue {
	return v.value
}

func (v *NullableNullableIssue) Set(val *NullableIssue) {
	v.value = val
	v.isSet = true
}

func (v NullableNullableIssue) IsSet() bool {
	return v.isSet
}

func (v *NullableNullableIssue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNullableIssue(val *NullableIssue) *NullableNullableIssue {
	return &NullableNullableIssue{value: val, isSet: true}
}

func (v NullableNullableIssue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNullableIssue) UnmarshalJSON(src []byte) error {
	v.isSet = true
