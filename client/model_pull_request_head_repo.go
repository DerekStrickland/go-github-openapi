...
// PullRequestHeadRepo struct for PullRequestHeadRepo
type PullRequestHeadRepo struct {
	...
	License NullablePullRequestHeadRepoLicense `json:"license"`
...
// If the value is explicit nil, the zero value for PullRequestHeadRepoLicense will be returned
func (o *PullRequestHeadRepo) GetLicense() PullRequestHeadRepoLicense {
	if o == nil || o.License.Get() == nil {
		var ret PullRequestHeadRepoLicense
		return ret
	}
...
func (o PullRequestHeadRepo) MarshalJSON() ([]byte, error) {
...
type NullablePullRequestHeadRepo struct {
	value *PullRequestHeadRepo
	isSet bool
}

func (v NullablePullRequestHeadRepo) Get() *PullRequestHeadRepo {
	return v.value
}

func (v *NullablePullRequestHeadRepo) Set(val *PullRequestHeadRepo) {
	v.value = val
	v.isSet = true
}

func (v NullablePullRequestHeadRepo) IsSet() bool {
	return v.isSet
}

func (v *NullablePullRequestHeadRepo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePullRequestHeadRepo(val *PullRequestHeadRepo) *NullablePullRequestHeadRepo {
	return &NullablePullRequestHeadRepo{value: val, isSet: true}
}

func (v NullablePullRequestHeadRepo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePullRequestHeadRepo) UnmarshalJSON(src []byte) error {
	v.isSet = true
